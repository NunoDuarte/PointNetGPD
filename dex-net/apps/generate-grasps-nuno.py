...
def do_job(i):
    ...
    good_grasp = worker(i, 2, 1, good_grasp)
    
    good_grasp_file_name = save_dir + "models/real_data_Nuno/" + "{}_{}_{}".format(filename_prefix, str(object_name), str(len(good_grasp)))
...
def print_job(i):
    ...
    good_grasp_file_name = save_dir + "models/real_data_Nuno/" + "{}_{}_{}".format(filename_prefix, str(object_name), str(3))
    with open(good_grasp_file_name + ".pickle", "r") as f:
        pickle.dump(good_grasp, f)
